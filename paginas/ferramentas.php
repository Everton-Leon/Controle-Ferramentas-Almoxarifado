...
<head>
    ...
    <title>Almoxerifado - Ferramentas</title>  
    <!-- Favicon -->
...
<body>
        ...
        <section class="row vh-100 ">
            ...
            <div id="menu-lateral" class="col-2 vh-100 position-fixed">
                ...
                <nav class="nav flex-column mt-4">
                    <a id="link-ativo" class="nav-link mb-2" href="#"><span>Ferramentas</span></a>
                ...
                <div id="div-sair" class="row align-items-end">
                    <a class="col-12" href="home.php">
            ...
            <div class="col-10 offset-2">
                ...
                <div class="col-8">
                    <h1 class="h1">Ferramentas</h1>
                </div>
                <div class="col-4 text-end">
                    <button type="button" class="btn btn-outline-dark" data-bs-toggle="modal" data-bs-target="#modal-cadastro">Adicionar Ferramenta</button>
                </div>
                <!-- Tabela -->
                </div>
                <div class="row my-3">
                <div class="col-12 table-responsive">
                    <table class="table table-sm table-striped table-bordered text-center align-middle">
                        ...
                        <tbody class="table-group-divider">
                            ...
                            <?php
                            $sql = "SELECT * FROM ferramentas order by ferramenta";
                            ...
                            <div class="modal-dialog modal-dialog-centered">
                                ...
                                <div class="modal-header">
                                    <h1 class="modal-title fs-5" id="staticBackdropLabel">Atualizar Ferramenta</h1>
                                    <button type="button" class="btn-close" data-bs-dismiss="modal" aria-label="Close"></button>
                                </div>
                                <div class="modal-body">
                                    <!-- Formulário de Cadastro  -->
                                    <form action="../php/atualizar-ferramenta.php" method="post" enctype="multipart/form-data">
                                        <div class="mb-3">
                                        ...
                                        <div class="mb-3">
                                            <label for="iferramenta" class="form-label">Ferramenta</label>
                                            <input type="text" class="form-control" id="iferramenta" name="ferramenta" placeholder="Martelo" required  minlength="1" value="<?php echo $dados['ferramenta']; ?>">
                                        </div>
                                        <div class="mb-3">
                                            <label for="ifoto" class="form-label">Imagem da Ferramenta</label>
                                            <input class="form-control" type="file" id="ifoto" name="foto">
                                            <input type="hidden" name="nome_imagem" value="<?php echo $dados['imagem_ferramenta']; ?>">
                                        </div>
                                        <button type="submit" class="btn btn-primary" name="btn-atualizar-ferramenta">Atualizar</button>
                            ...
                            <div class="modal-dialog modal-dialog-centered">
                                <div class="modal-content">
                                <div class="modal-header">
                                    <h1 class="modal-title fs-5" id="staticBackdropLabel">Deletar Ferramenta</h1>
                                    <button type="button" class="btn-close" data-bs-dismiss="modal" aria-label="Close"></button>
                                </div>
                                <div class="modal-body">
                                    Certeza que deseja excluir a ferramenta <strong><?php echo $dados['ferramenta']; ?></strong>?
                                    <!-- Formulário de Cadastro  -->
                                    <form action="../php/deletar-ferramenta.php" method="post" enctype="multipart/form-data">
                                        <div class="mb-3">
                                            <input type="hidden" name="id" value="<?php echo $dados['id']; ?>">
                                        </div>
                                        <button type="submit" class="btn btn-primary" name="btn-deletar-ferramenta">Sim</button>
                                        <button type="button" class="btn btn-secondary" data-bs-dismiss="modal">Cancelar</button>
                                    </form>
                                </div>
                                </div>
    ...
    <div class="modal-dialog modal-dialog-centered">
        <div class="modal-content">
        <div class="modal-header">
            <h1 class="modal-title fs-5" id="staticBackdropLabel">Cadastro de Ferramenta</h1>
            <button type="button" class="btn-close" data-bs-dismiss="modal" aria-label="Close"></button>
        </div>
        <div class="modal-body">
            <!-- Formulário de Cadastro  -->
            <form action="../php/cadastrar-ferramenta.php" method="post" enctype="multipart/form-data">
                <div class="mb-3">
                    <label for="icodigo" class="form-label">Código</label>
                ...
                <div class="mb-3">
                    <label for="iferramenta" class="form-label">Ferramenta</label>
                    <input type="text" class="form-control" id="iferramenta" name="ferramenta" placeholder="Martelo" required  minlength="1">
                </div>
                <div class="mb-3">
                    <label for="ifoto" class="form-label">Imagem da Ferramenta</label>
                    <input class="form-control" type="file" id="ifoto" name="foto">
                </div>
                <button type="submit" class="btn btn-primary" name="btn-cadastrar-ferramenta">Cadastrar</button>
                <button type="button" class="btn btn-secondary" data-bs-dismiss="modal">Cancelar</button>
            </form>
        </div>
        </div>
