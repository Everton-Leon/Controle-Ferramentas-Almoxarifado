...
if (isset($_POST['btn-atualizar-efetivo'])):
    $id = $_POST['id'];
    ...
    if (!empty($foto["name"])):
        ...
        if (count($error) == 0):  
            ...
            $sql = "UPDATE efetivo SET codigo = '$codigo', nome = '$nome', funcao = '$funcao', encarregado = '$encarregado', secao = '$secao', situacao = '$situacao', frente_servico = '$frente_servico', imagem_efetivo = '$nome_imagem' WHERE id = '$id'";
        
            // Se os dados forem atualizados com sucesso
            if (mysqli_query($connect, $sql)):
                $_SESSION['mensagem'] = "Efetivo atualizado com sucesso!";
                header("Location: ../paginas/efetivo.php");
            else:
                $_SESSION['mensagem'] = "Erro ao atualizar efetivo: ". mysqli_error($connect);
                header("Location: ../paginas/efetivo.php");
            endif;
        else:
